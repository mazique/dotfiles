...
# Duplicate Terminal app and check open with rosetta

# Computer Name (Ares)
# Admin Account (Ruler)
# Standard Account (Neeko)
...
# Minimal setup
dockutil --add /Applications/CleanMyMac.app > /dev/null 2>&1
...
dockutil --add /Applications/Microsoft\ 365.app > /dev/null 2>&1
dockutil --add /Applications/Shortcuts.app > /dev/null 2>&1
dockutil --add /Applications/The\ Sims\ 4.app > /dev/null 2>&1
...
# Set standby delay to 20 minutes (default is 1 hour)
